...
| **Falco** | `falco` (falcosecurity charts) | 8.0.5 | `falco` | Image tag `0.44.0-rc2` (the 0.44.0 release line), modern eBPF driver, container plugin `0.7.1`, k8smeta plugin `0.4.1`, metrics + ServiceMonitor enabled, Grafana dashboards ([`falco.yaml`](../../../refs/falcosecurity/test-infra/config/applications/falco.yaml)) |
