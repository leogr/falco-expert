...
Check what era/version each repo targets. The knowledge base documents era 0.45 — if repos are ahead (targeting 0.46+), APIs and behaviors may differ.
...
If the user says "fix a bug in 0.45" but `master` targets 0.46, clarify whether they want a hotfix branch or a fix on `master`.
