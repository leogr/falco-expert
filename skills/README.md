...
| [`falco-maintainer`](falco-maintainer/) | Discover and rank strategic sub-projects, advance approved jobs, and keep a lightweight ongoing watch; public actions and substantial implementation need explicit approval | 0.44 |
| [`falco-release`](falco-release/) | Assist a Falco release manager end to end (inventory, tracking issue, candidates, freeze and sync, GA day, post-release) without ever performing the final release | 0.44 |
...
| [`falco-triage`](falco-triage/) | Triage GitHub issues and PRs across falcosecurity repositories | 0.44 |

## Guidelines

- **Do not create new skills without explicit request**
