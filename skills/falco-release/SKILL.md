...
| Chart sync job, branch protection, cluster pins | [`OCI automation/charts.yaml`](../../refs/falcosecurity/test-infra/config/jobs/oci/automation/charts.yaml), [`config.yaml`](../../refs/falcosecurity/test-infra/config/prow/aws/config.yaml), [`applications/falco.yaml`](../../refs/falcosecurity/test-infra/config/applications/aws/falco.yaml) |
